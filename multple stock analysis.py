...
for ticker in tickers:
    ...
    print('Buy and hold strategy return:', data['Buy_and_hold'][-1])
    print('SMA return:', sma_invested['Return'][-1] if not sma_invested.empty else 'No SMA trades')
    print('EWM return:', ewm_invested['Return'][-1] if not ewm_invested.empty else 'No EWM trades')
